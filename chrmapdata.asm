...
AreaAddrOffsets:
World1Areas: .db $40, $60, $81, $42, $C3
World2Areas: .db $44, $20, $05, $46, $C7
World3Areas: .db $48, $49, $4A, $CB
World4Areas: .db $4C, $20, $8D, $4E, $CF
World5Areas: .db $50, $51, $52, $D3
World6Areas: .db $54, $55, $56, $D7
World7Areas: .db $58, $20, $19, $5A, $DB
World8Areas: .db $5C, $5D, $5E, $DF

AreaDataAddrLow:
	db LOW(L_room_00), LOW(L_room_01), LOW(L_room_02), LOW(L_room_03)
	db LOW(L_room_04), LOW(L_room_05), LOW(L_room_06), LOW(L_room_07)
	db LOW(L_room_08), LOW(L_room_09), LOW(L_room_0A), LOW(L_room_0B)
	db LOW(L_room_0C), LOW(L_room_0D), LOW(L_room_0E), LOW(L_room_0F)
	db LOW(L_room_10), LOW(L_room_11), LOW(L_room_12), LOW(L_room_13)
	db LOW(L_room_14), LOW(L_room_15), LOW(L_room_16), LOW(L_room_17)
	db LOW(L_room_18), LOW(L_room_19), LOW(L_room_1A), LOW(L_room_1B)
	db LOW(L_room_1C), LOW(L_room_1D), LOW(L_room_1E), LOW(L_room_1F)
	db LOW(L_room_20), LOW(L_room_21), LOW(L_room_22), LOW(L_room_23)
	db LOW(L_room_24), LOW(L_room_25), LOW(L_room_26), LOW(L_room_27)
;	db LOW(L_room_28), LOW(L_room_29), LOW(L_room_2A), LOW(L_room_2B)
;	db LOW(L_room_2C), LOW(L_room_2D), LOW(L_room_2E), LOW(L_room_2F)

AreaDataAddrHigh:
	db HIGH(L_room_00), HIGH(L_room_01), HIGH(L_room_02), HIGH(L_room_03)
	db HIGH(L_room_04), HIGH(L_room_05), HIGH(L_room_06), HIGH(L_room_07)
	db HIGH(L_room_08), HIGH(L_room_09), HIGH(L_room_0A), HIGH(L_room_0B)
	db HIGH(L_room_0C), HIGH(L_room_0D), HIGH(L_room_0E), HIGH(L_room_0F)
	db HIGH(L_room_10), HIGH(L_room_11), HIGH(L_room_12), HIGH(L_room_13)
	db HIGH(L_room_14), HIGH(L_room_15), HIGH(L_room_16), HIGH(L_room_17)
	db HIGH(L_room_18), HIGH(L_room_19), HIGH(L_room_1A), HIGH(L_room_1B)
	db HIGH(L_room_1C), HIGH(L_room_1D), HIGH(L_room_1E), HIGH(L_room_1F)
	db HIGH(L_room_20), HIGH(L_room_21), HIGH(L_room_22), HIGH(L_room_23)
	db HIGH(L_room_24), HIGH(L_room_25), HIGH(L_room_26), HIGH(L_room_27)
;	db HIGH(L_room_28), HIGH(L_room_29), HIGH(L_room_2A), HIGH(L_room_2B)
;	db HIGH(L_room_2C), HIGH(L_room_2D), HIGH(L_room_2E), HIGH(L_room_2F)
